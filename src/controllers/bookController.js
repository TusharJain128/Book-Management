...
const createBook = async (req, res) => {
    try {
        ...
        if (!Validation.isValid(title)) {
            return res.status(400).send({ status: false, message: "Please give title in a string" })
        }
        ...
        if (!Validation.isValid(excerpt)) {
            return res.status(400).send({ status: false, message: "Please give excerpt in a string" })
        }
...
//           }
        ...
        if (!Validation.isValid(userId)) {
            return res.status(400).send({ status: false, message: "Please give title in a userId" })
        }
        ...
        if (!Validation.isValid(ISBN)) {
            return res.status(400).send({ status: false, message: "Please give ISBN in a string" })
        }
        ...
        if (!Validation.isValid(category)) {
            return res.status(400).send({ status: false, message: "Please give category in a string" })
        }

        dcategory = data.category = category.trim()
        ...
        if (!Validation.isValid(subcategory)) {
            return res.status(400).send({ status: false, message: "Please give subcategory in a string" })
        }
        ...
        if (!Validation.isValid(releasedAt)) {
            return res.status(400).send({ status: false, message: "Please give date in a string" })
        }
//         releasedAt = data.releasedAt = releasedAt.trim()
        ...
        if (Object.keys(rest).length !== 0) {
            return res.status(400).send({ status: false, message: "you can send only title,excerpt,userId,ISBN,category,subcategory" })
        }
...
const getBookDetails = async (req, res) => {
    try {
        ...
        if (Object.keys(rest).length !== 0) {
            return res.status(404).send({ status: false, message: "You can filter books by userId,category,subcategory" })
        }
        ...
        res.status(200).send({ status: true, message: "Success", data: savedData })
...
const getbookById = async function (req, res) {
    try {
        ...
        if (!mongoose.isValidObjectId(bookId)) return res.status(400).send({ status: false, message: "Please enter valid id in path param" })
